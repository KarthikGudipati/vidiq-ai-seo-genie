    ...
    <footer className="w-full border-t bg-white py-12">
      <div className="container grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-gray-500">
            AI-powered SEO optimization for your videos to boost visibility and engagement.
          </p>
        </div>
        
        <div className="flex flex-col gap-2">
          <h3 className="text-lg font-medium">Product</h3>
          <Link to="/features" className="text-sm text-gray-500 hover:text-primary">
            Features
          </Link>
        ...
        <div className="flex flex-col gap-2">
          ...
          <a href="mailto:support@seokeywordguru.com" className="text-sm text-gray-500 hover:text-primary">
            support@seokeywordguru.com
          </a>
      ...
      <div className="container mt-8 border-t pt-8">
        <p className="text-center text-sm text-gray-500">
          &copy; 2025 SEO Keyword Guru. All rights reserved.
        </p>
      </div>
    </footer>
  );
